...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String USER_PW_PREF = "user_pw_pref";
    ...
    public void checkLoggedIn(){
        ...
        String username = sharedPrefs.getString(USER_NAME_PREF, "");
    ...
    public void loginComplete(){
        //You are logged in so lets move on
        Intent intent= new Intent(this, MainActivity.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK); //Don't let the user come back to this
    ...
    public void loginSuccess(boolean success, String userFirstName){
